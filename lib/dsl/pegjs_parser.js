...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c70 = function(method) { return { method: method, path: '' }; },
      peg$c71 = /^[.A-z0-9\-_]/,
      peg$c72 = peg$classExpectation([".", ["A", "z"], ["0", "9"], "-", "_"], false, false),
      peg$c73 = function(method, path) { return { method: method, path: path.join('') }; },
  ...
  function peg$parsemicroserviceMethodDeclaration() {
    var s0, s1, s2, s3, s4, s5;
