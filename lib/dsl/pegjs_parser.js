...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c60 = function(decl, ex) {
          parsed.microservice[decl.method] =
            parsed.microservice[decl.method] || { list: [], excluded: [], path: decl.path };
          parsed.microservice[decl.method].path = decl.path;
          addUniqueElements(parsed.microservice[decl.method].list, decl.entityList);
          if (ex) {
            addUniqueElements(parsed.microservice[decl.method].excluded, ex);
          }
      ...
      peg$c69 = function(entityList, path) {
          return {
            entityList: entityList.slice(0, entityList.length -1),
            method: entityList[entityList.length - 1],
            path: path || entityList[entityList.length - 1]
          };
        },
      peg$c70 = /^[.\/A-z0-9\-_]/,
      peg$c71 = peg$classExpectation([".", "/", ["A", "z"], ["0", "9"], "-", "_"], false, false),
      peg$c72 = function(path) { return path.join('') },
      peg$c73 = function() { return null; },
      peg$c74 = function() { return 'one-to-one'; },
      peg$c75 = function() { return 'one-to-many'; },
      peg$c76 = function() { return 'many-to-one'; },
      peg$c77 = function() { return 'many-to-many'; },
      peg$c78 = /^[A-Z]/,
      peg$c79 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c80 = /^[A-z0-9]/,
      peg$c81 = peg$classExpectation([["A", "z"], ["0", "9"]], false, false),
      peg$c82 = function(head, tail) { return `${head}${tail.join('')}`; },
      peg$c83 = function() { return { key: 'required', value: '' }; },
      peg$c84 = function(int) { return { key: 'minlength', value: int }; },
      peg$c85 = function(constantName) { return { key: 'minlength', value: constantName, constant: true }; },
      peg$c86 = function(int) { return { key: 'maxlength', value: int }; },
      peg$c87 = function(constantName) { return { key: 'maxlength', value: constantName, constant: true }; },
      peg$c88 = function(int) { return { key: 'minbytes', value: int }; },
      peg$c89 = function(constantName) { return { key: 'minbytes', value: constantName, constant: true }; },
      peg$c90 = function(int) { return { key: 'maxbytes', value: int }; },
      peg$c91 = function(constantName) { return { key: 'maxbytes', value: constantName, constant: true }; },
      peg$c92 = function(int) { return { key: 'min', value: int };},
      peg$c93 = function(constantName) { return { key: 'min', value: constantName, constant: true };},
      peg$c94 = function(int) { return { key: 'max', value: int };},
      peg$c95 = function(constantName) { return { key: 'max', value: constantName, constant: true };},
      peg$c96 = function(regex) { return { key: 'pattern', value: regex }; },
      peg$c97 = function(notAComment) { return notAComment.join(''); },
      peg$c98 = "/*",
      ...
      peg$c106 = "entity",
      peg$c107 = peg$literalExpectation("entity", false),
      peg$c108 = "relationship",
      peg$c109 = peg$literalExpectation("relationship", false),
      peg$c110 = "enum",
      peg$c111 = peg$literalExpectation("enum", false),
      peg$c112 = "OneToOne",
      peg$c113 = peg$literalExpectation("OneToOne", false),
      peg$c114 = "OneToMany",
      peg$c115 = peg$literalExpectation("OneToMany", false),
      peg$c116 = "ManyToOne",
      peg$c117 = peg$literalExpectation("ManyToOne", false),
      peg$c118 = "ManyToMany",
      peg$c119 = peg$literalExpectation("ManyToMany", false),
      peg$c120 = "all",
      peg$c121 = peg$literalExpectation("all", false),
      peg$c122 = "*",
      peg$c123 = peg$literalExpectation("*", false),
      peg$c124 = "for",
      peg$c125 = peg$literalExpectation("for", false),
      peg$c126 = "with",
      peg$c127 = peg$literalExpectation("with", false),
      peg$c128 = "except",
      peg$c129 = peg$literalExpectation("except", false),
      peg$c130 = "noFluentMethod",
      peg$c131 = peg$literalExpectation("noFluentMethod", false),
      peg$c132 = "dto",
      peg$c133 = peg$literalExpectation("dto", false),
      peg$c134 = "paginate",
      peg$c135 = peg$literalExpectation("paginate", false),
      peg$c136 = "service",
      peg$c137 = peg$literalExpectation("service", false),
      peg$c138 = "microservice",
      peg$c139 = peg$literalExpectation("microservice", false),
      peg$c140 = "search",
      peg$c141 = peg$literalExpectation("search", false),
      peg$c142 = "skipClient",
      peg$c143 = peg$literalExpectation("skipClient", false),
      peg$c144 = "skipServer",
      peg$c145 = peg$literalExpectation("skipServer", false),
      peg$c146 = "angularSuffix",
      peg$c147 = peg$literalExpectation("angularSuffix", false),
      peg$c148 = "minlength",
      ...
      peg$c186 = function(word) { return word.join('') },
      peg$c187 = /^["|']/,
  ...
  function peg$parsemicroserviceDecl1() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parsemicroserviceEntityList();
        if (s3 !== peg$FAILED) {
          s4 = [];
          s5 = peg$parseSPACE();
          while (s5 !== peg$FAILED) {
  ...
  function peg$parsemicroserviceEntityList() {
    var s0, s1, s2, s3;

    s0 = peg$currPos;
    s1 = peg$parseentityList();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$parseSPACE();
      while (s3 !== peg$FAILED) {
  ...
  function peg$parsemicroservicePath() {
    var s0, s1, s2, s3, s4, s5;
