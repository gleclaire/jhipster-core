...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c60 = function(decl, path, ex) {
          ...
          parsed.microservice[decl[decl.length - 1]].path = path;
          console.log(parsed.microservice[decl[decl.length - 1]]);
      ...
      peg$c65 = function(method) { return ['*', method]; },
      peg$c66 = function(e, method) { return [e, method]; },
      peg$c67 = /^[A-z0-9\-]/,
      peg$c68 = peg$classExpectation([["A", "z"], ["0", "9"], "-"], false, false),
      peg$c69 = function(method) { return method.join(''); },
      peg$c70 = /^[.\/A-z0-9\-_]/,
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          ...
          if (s4 !== peg$FAILED) {
            s5 = peg$parsemicroservicePathDeclaration();
            if (s5 === peg$FAILED) {
              s5 = null;
            }
            if (s5 !== peg$FAILED) {
  ...
  function peg$parsemicroservicePathDeclaration() {
    var s0, s1, s2, s3;
